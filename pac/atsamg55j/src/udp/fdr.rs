...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifo_data(&mut self) -> FifoDataW<FdrSpec> {
        FifoDataW::new(self, 0)
    }
}
#[doc = "Endpoint FIFO Data Register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdr::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FdrSpec;
