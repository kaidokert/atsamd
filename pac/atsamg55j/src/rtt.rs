...
#[doc = "Status Register"]
pub mod sr;
#[doc = "MODR (rw) register accessor: Modulo Selection Register\n\nYou can [`read`](crate::Reg::read) this register and get [`modr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`modr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@modr`]
module"]
#[doc(alias = "MODR")]
pub type Modr = crate::Reg<modr::ModrSpec>;
