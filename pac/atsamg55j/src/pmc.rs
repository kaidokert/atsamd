...
pub struct RegisterBlock {
    ...
    pmc_pcr: PmcPcr,
    pmc_ocr: PmcOcr,
    pmc_slpwk_er0: PmcSlpwkEr0,
    pmc_slpwk_dr0: PmcSlpwkDr0,
    pmc_slpwk_sr0: PmcSlpwkSr0,
    pmc_slpwk_asr0: PmcSlpwkAsr0,
    _reserved31: [u8; 0x0c],
    pmc_pmmr: PmcPmmr,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pmc_slpwk_er0(&self) -> &PmcSlpwkEr0 {
        &self.pmc_slpwk_er0
    }
    #[doc = "0x118 - SleepWalking Disable Register 0"]
    #[inline(always)]
    pub const fn pmc_slpwk_dr0(&self) -> &PmcSlpwkDr0 {
        &self.pmc_slpwk_dr0
    }
    #[doc = "0x11c - SleepWalking Status Register 0"]
    #[inline(always)]
    pub const fn pmc_slpwk_sr0(&self) -> &PmcSlpwkSr0 {
        &self.pmc_slpwk_sr0
    }
    #[doc = "0x120 - SleepWalking Activity Status Register 0"]
    #[inline(always)]
    pub const fn pmc_slpwk_asr0(&self) -> &PmcSlpwkAsr0 {
        &self.pmc_slpwk_asr0
    }
    #[doc = "0x130 - PLL Maximum Multiplier Value Register"]
    #[inline(always)]
    pub const fn pmc_pmmr(&self) -> &PmcPmmr {
        &self.pmc_pmmr
    }
}
...
pub mod pmc_ocr;
#[doc = "PMC_SLPWK_ER0 (w) register accessor: SleepWalking Enable Register 0\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_slpwk_er0::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pmc_slpwk_er0`]
module"]
#[doc(alias = "PMC_SLPWK_ER0")]
pub type PmcSlpwkEr0 = crate::Reg<pmc_slpwk_er0::PmcSlpwkEr0Spec>;
#[doc = "SleepWalking Enable Register 0"]
pub mod pmc_slpwk_er0;
#[doc = "PMC_SLPWK_DR0 (w) register accessor: SleepWalking Disable Register 0\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_slpwk_dr0::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pmc_slpwk_dr0`]
module"]
#[doc(alias = "PMC_SLPWK_DR0")]
pub type PmcSlpwkDr0 = crate::Reg<pmc_slpwk_dr0::PmcSlpwkDr0Spec>;
#[doc = "SleepWalking Disable Register 0"]
pub mod pmc_slpwk_dr0;
#[doc = "PMC_SLPWK_SR0 (r) register accessor: SleepWalking Status Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pmc_slpwk_sr0::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pmc_slpwk_sr0`]
module"]
#[doc(alias = "PMC_SLPWK_SR0")]
pub type PmcSlpwkSr0 = crate::Reg<pmc_slpwk_sr0::PmcSlpwkSr0Spec>;
#[doc = "SleepWalking Status Register 0"]
pub mod pmc_slpwk_sr0;
#[doc = "PMC_SLPWK_ASR0 (r) register accessor: SleepWalking Activity Status Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pmc_slpwk_asr0::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pmc_slpwk_asr0`]
module"]
#[doc(alias = "PMC_SLPWK_ASR0")]
pub type PmcSlpwkAsr0 = crate::Reg<pmc_slpwk_asr0::PmcSlpwkAsr0Spec>;
#[doc = "SleepWalking Activity Status Register 0"]
pub mod pmc_slpwk_asr0;
#[doc = "PMC_PMMR (rw) register accessor: PLL Maximum Multiplier Value Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pmc_pmmr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_pmmr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pmc_pmmr`]
module"]
#[doc(alias = "PMC_PMMR")]
pub type PmcPmmr = crate::Reg<pmc_pmmr::PmcPmmrSpec>;
