...
impl TrgselR {
    ...
    pub fn is_adc_trig6(&self) -> bool {
        *self == Trgsel::AdcTrig6
    }
    #[doc = "-"]
    #[inline(always)]
    pub fn is_adc_trig7(&self) -> bool {
        *self == Trgsel::AdcTrig7
    }
}
#[doc = "Field `TRGSEL` writer - Trigger Selection"]
pub type TrgselW<'a, REG> = crate::FieldWriter<'a, REG, 3, Trgsel, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "RTTEVENT"]
    #[inline(always)]
    pub fn adc_trig6(self) -> &'a mut crate::W<REG> {
        self.variant(Trgsel::AdcTrig6)
    }
    #[doc = "-"]
    #[inline(always)]
    pub fn adc_trig7(self) -> &'a mut crate::W<REG> {
        self.variant(Trgsel::AdcTrig7)
    }
}
#[doc = "Sleep Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
