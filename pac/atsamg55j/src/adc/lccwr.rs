...
pub type R = crate::R<LccwrSpec>;
#[doc = "Register `LCCWR` writer"]
pub type W = crate::W<LccwrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lowthres(&mut self) -> LowthresW<LccwrSpec> {
        LowthresW::new(self, 0)
    }
    #[doc = "Bits 16:27 - High Threshold"]
    #[inline(always)]
    #[must_use]
    pub fn highthres(&mut self) -> HighthresW<LccwrSpec> {
        HighthresW::new(self, 16)
    }
}
#[doc = "Last Channel Compare Window Register\n\nYou can [`read`](crate::Reg::read) this register and get [`lccwr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lccwr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LccwrSpec;
impl crate::RegisterSpec for LccwrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lccwr::R`](R) reader structure"]
impl crate::Readable for LccwrSpec {}
#[doc = "`write(|w| ..)` method takes [`lccwr::W`](W) writer structure"]
impl crate::Writable for LccwrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LCCWR to value 0"]
impl crate::Resettable for LccwrSpec {
