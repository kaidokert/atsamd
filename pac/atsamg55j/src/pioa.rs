...
pub mod pusr;
#[doc = "ABCDSR (rw) register accessor: Peripheral Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`abcdsr::R`]. You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`abcdsr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@abcdsr`]
module"]
#[doc(alias = "ABCDSR")]
