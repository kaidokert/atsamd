...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn lctmr(&self) -> &Lctmr {
        &self.lctmr
    }
    #[doc = "0x38 - Last Channel Compare Window Register"]
    #[inline(always)]
    pub const fn lccwr(&self) -> &Lccwr {
        &self.lccwr
    }
...
pub mod isr;
#[doc = "LCTMR (rw) register accessor: Last Channel Trigger Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`lctmr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lctmr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lctmr`]
module"]
#[doc(alias = "LCTMR")]
pub type Lctmr = crate::Reg<lctmr::LctmrSpec>;
#[doc = "Last Channel Trigger Mode Register"]
pub mod lctmr;
#[doc = "LCCWR (rw) register accessor: Last Channel Compare Window Register\n\nYou can [`read`](crate::Reg::read) this register and get [`lccwr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lccwr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lccwr`]
module"]
#[doc(alias = "LCCWR")]
pub type Lccwr = crate::Reg<lccwr::LccwrSpec>;
