...
impl ModeR {
    ...
    pub const fn variant(&self) -> Option<Mode> {
        match self.bits {
            0 => Some(Mode::CycleCount),
            1 => Some(Mode::IhitCount),
            2 => Some(Mode::DhitCount),
            _ => None,
        }
    }
    #[doc = "Cycle counter"]
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn cycle_count(self) -> &'a mut crate::W<REG> {
        self.variant(Mode::CycleCount)
    }
    #[doc = "Instruction hit counter"]
    #[inline(always)]
    pub fn ihit_count(self) -> &'a mut crate::W<REG> {
        self.variant(Mode::IhitCount)
    }
    #[doc = "Data hit counter"]
    #[inline(always)]
    pub fn dhit_count(self) -> &'a mut crate::W<REG> {
        self.variant(Mode::DhitCount)
    }
}
impl R {
