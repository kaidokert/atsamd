...
pub mod sr;
#[doc = "PWMR (rw) register accessor: Supply Controller Power Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pwmr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwmr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pwmr`]
module"]
#[doc(alias = "PWMR")]
pub type Pwmr = crate::Reg<pwmr::PwmrSpec>;
