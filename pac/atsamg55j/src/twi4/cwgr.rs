...
pub type BrsrcclkR = crate::BitReader;
#[doc = "Field `BRSRCCLK` writer - Bit Rate Source Clock"]
pub type BrsrcclkW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HoldW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ...
    pub fn hold(&self) -> HoldR {
        HoldR::new(((self.bits >> 24) & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Clock Low Divider"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn brsrcclk(&mut self) -> BrsrcclkW<CwgrSpec> {
