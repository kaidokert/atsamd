...
pub type Inc2aenR = crate::BitReader;
#[doc = "Field `INC2AEN` writer - RTTINC2 Alarm Enable"]
pub type Inc2aenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EVAEN` reader - Trigger Event Alarm Enable"]
pub type EvaenR = crate::BitReader;
#[doc = "Field `EVAEN` writer - Trigger Event Alarm Enable"]
pub type EvaenW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn inc2aen(&self) -> Inc2aenR {
        Inc2aenR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Trigger Event Alarm Enable"]
    #[inline(always)]
    pub fn evaen(&self) -> EvaenR {
        EvaenR::new(((self.bits >> 22) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inc2aen(&mut self) -> Inc2aenW<MrSpec> {
        Inc2aenW::new(self, 21)
    }
    #[doc = "Bit 22 - Trigger Event Alarm Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evaen(&mut self) -> EvaenW<MrSpec> {
        EvaenW::new(self, 22)
    }
    #[doc = "Bit 24 - Real-Time Clock 1Hz Clock Selection"]
    #[inline(always)]
