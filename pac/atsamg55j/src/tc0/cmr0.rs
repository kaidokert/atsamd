...
impl From<Sbsmplr> for u8 {
    #[inline(always)]
    fn from(variant: Sbsmplr) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Sbsmplr {
    type Ux = u8;
}
impl crate::IsEnum for Sbsmplr {}
#[doc = "Field `SBSMPLR` reader - Loading Edge Subsampling Ratio"]
pub type SbsmplrR = crate::FieldReader<Sbsmplr>;
impl SbsmplrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Sbsmplr> {
        match self.bits {
            0 => Some(Sbsmplr::One),
            1 => Some(Sbsmplr::Half),
            2 => Some(Sbsmplr::Fourth),
            3 => Some(Sbsmplr::Eighth),
            4 => Some(Sbsmplr::Sixteenth),
            _ => None,
        }
    }
    ...
    pub fn is_sixteenth(&self) -> bool {
        *self == Sbsmplr::Sixteenth
    }
}
#[doc = "Field `SBSMPLR` writer - Loading Edge Subsampling Ratio"]
pub type SbsmplrW<'a, REG> = crate::FieldWriter<'a, REG, 3, Sbsmplr>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sbsmplr(&mut self) -> SbsmplrW<Cmr0Spec> {
