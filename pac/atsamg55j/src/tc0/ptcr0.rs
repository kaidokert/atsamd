...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxten(&mut self) -> RxtenW<Ptcr0Spec> {
        RxtenW::new(self, 0)
    }
    #[doc = "Bit 1 - Receiver Transfer Disable"]
    #[inline(always)]
    #[must_use]
    pub fn rxtdis(&mut self) -> RxtdisW<Ptcr0Spec> {
        RxtdisW::new(self, 1)
    }
    #[doc = "Bit 8 - Transmitter Transfer Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txten(&mut self) -> TxtenW<Ptcr0Spec> {
        TxtenW::new(self, 8)
    }
    #[doc = "Bit 9 - Transmitter Transfer Disable"]
    #[inline(always)]
    #[must_use]
    pub fn txtdis(&mut self) -> TxtdisW<Ptcr0Spec> {
        TxtdisW::new(self, 9)
    }
    #[doc = "Bit 16 - Receiver Circular Buffer Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxcben(&mut self) -> RxcbenW<Ptcr0Spec> {
        RxcbenW::new(self, 16)
    }
    #[doc = "Bit 17 - Receiver Circular Buffer Disable"]
    #[inline(always)]
    #[must_use]
    pub fn rxcbdis(&mut self) -> RxcbdisW<Ptcr0Spec> {
        RxcbdisW::new(self, 17)
    }
    #[doc = "Bit 18 - Transmitter Circular Buffer Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txcben(&mut self) -> TxcbenW<Ptcr0Spec> {
        TxcbenW::new(self, 18)
    }
    #[doc = "Bit 19 - Transmitter Circular Buffer Disable"]
    #[inline(always)]
    #[must_use]
    pub fn txcbdis(&mut self) -> TxcbdisW<Ptcr0Spec> {
        TxcbdisW::new(self, 19)
    }
    #[doc = "Bit 24 - Transfer Bus Error Clear"]
    #[inline(always)]
    #[must_use]
    pub fn errclr(&mut self) -> ErrclrW<Ptcr0Spec> {
        ErrclrW::new(self, 24)
    }
}
#[doc = "Transfer Control Register (pdc = 0)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ptcr0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ptcr0Spec;
impl crate::RegisterSpec for Ptcr0Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ptcr0::W`](W) writer structure"]
impl crate::Writable for Ptcr0Spec {
