...
pub type PllaenR = crate::FieldReader;
#[doc = "Field `PLLAEN` writer - PLLA Control"]
pub type PllaenW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type MulaW<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
...
impl R {
    ...
    #[inline(always)]
    pub fn pllaen(&self) -> PllaenR {
        PllaenR::new((self.bits & 0xff) as u8)
    }
    ...
    pub fn mula(&self) -> MulaR {
        MulaR::new(((self.bits >> 16) & 0x1fff) as u16)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllaen(&mut self) -> PllaenW<CkgrPllarSpec> {
        PllaenW::new(self, 0)
    }
    #[doc = "Bits 8:13 - PLLA Counter"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn zero(&mut self) -> ZeroW<CkgrPllarSpec> {
        ZeroW::new(self, 29)
    }
}
