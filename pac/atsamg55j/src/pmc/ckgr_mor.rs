...
impl MoscrcfR {
    ...
    pub const fn variant(&self) -> Option<Moscrcf> {
        match self.bits {
            0 => Some(Moscrcf::_8Mhz),
            1 => Some(Moscrcf::_16Mhz),
            2 => Some(Moscrcf::_24Mhz),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "The fast RC oscillator frequency is at 16 MHz"]
    #[inline(always)]
    pub fn _16_mhz(self) -> &'a mut crate::W<REG> {
        self.variant(Moscrcf::_16Mhz)
    }
    #[doc = "The fast RC oscillator frequency is at 24 MHz"]
    #[inline(always)]
    pub fn _24_mhz(self) -> &'a mut crate::W<REG> {
        self.variant(Moscrcf::_24Mhz)
    }
}
