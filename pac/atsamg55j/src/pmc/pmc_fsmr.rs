...
impl From<Flpm> for u8 {
    #[inline(always)]
    fn from(variant: Flpm) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Flpm {
    type Ux = u8;
}
impl crate::IsEnum for Flpm {}
#[doc = "Field `FLPM` reader - Flash Low-power Mode"]
pub type FlpmR = crate::FieldReader<Flpm>;
impl FlpmR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Flpm> {
        match self.bits {
            0 => Some(Flpm::FlashStandby),
            1 => Some(Flpm::FlashDeepPowerdown),
            2 => Some(Flpm::FlashIdle),
            _ => None,
        }
    }
...
pub type FlpmW<'a, REG> = crate::FieldWriter<'a, REG, 2, Flpm>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn flash_standby(self) -> &'a mut crate::W<REG> {
        self.variant(Flpm::FlashStandby)
    }
    #[doc = "Flash is in Deep-power-down mode when system enters Wait Mode"]
    #[inline(always)]
    pub fn flash_deep_powerdown(self) -> &'a mut crate::W<REG> {
        self.variant(Flpm::FlashDeepPowerdown)
    }
    #[doc = "Idle mode"]
    #[inline(always)]
    pub fn flash_idle(self) -> &'a mut crate::W<REG> {
        self.variant(Flpm::FlashIdle)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flpm(&mut self) -> FlpmW<PmcFsmrSpec> {
        FlpmW::new(self, 21)
    }
    #[doc = "Bit 23 - Force Flash Low-power Mode"]
    #[inline(always)]
    #[must_use]
    pub fn fflpm(&mut self) -> FflpmW<PmcFsmrSpec> {
        FflpmW::new(self, 23)
    }
}
