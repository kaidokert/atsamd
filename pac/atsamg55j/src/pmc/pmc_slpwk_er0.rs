...
pub type W = crate::W<PmcSlpwkEr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid8(&mut self) -> Pid8W<PmcSlpwkEr0Spec> {
        Pid8W::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral 9 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid9(&mut self) -> Pid9W<PmcSlpwkEr0Spec> {
        Pid9W::new(self, 9)
    }
    #[doc = "Bit 10 - Peripheral 10 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid10(&mut self) -> Pid10W<PmcSlpwkEr0Spec> {
        Pid10W::new(self, 10)
    }
    #[doc = "Bit 11 - Peripheral 11 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid11(&mut self) -> Pid11W<PmcSlpwkEr0Spec> {
        Pid11W::new(self, 11)
    }
    #[doc = "Bit 12 - Peripheral 12 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid12(&mut self) -> Pid12W<PmcSlpwkEr0Spec> {
        Pid12W::new(self, 12)
    }
    #[doc = "Bit 13 - Peripheral 13 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid13(&mut self) -> Pid13W<PmcSlpwkEr0Spec> {
        Pid13W::new(self, 13)
    }
    #[doc = "Bit 14 - Peripheral 14 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid14(&mut self) -> Pid14W<PmcSlpwkEr0Spec> {
        Pid14W::new(self, 14)
    }
    #[doc = "Bit 15 - Peripheral 15 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid15(&mut self) -> Pid15W<PmcSlpwkEr0Spec> {
        Pid15W::new(self, 15)
    }
    #[doc = "Bit 16 - Peripheral 16 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid16(&mut self) -> Pid16W<PmcSlpwkEr0Spec> {
        Pid16W::new(self, 16)
    }
    #[doc = "Bit 17 - Peripheral 17 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid17(&mut self) -> Pid17W<PmcSlpwkEr0Spec> {
        Pid17W::new(self, 17)
    }
    #[doc = "Bit 18 - Peripheral 18 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid18(&mut self) -> Pid18W<PmcSlpwkEr0Spec> {
        Pid18W::new(self, 18)
    }
    #[doc = "Bit 19 - Peripheral 19 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid19(&mut self) -> Pid19W<PmcSlpwkEr0Spec> {
        Pid19W::new(self, 19)
    }
    #[doc = "Bit 20 - Peripheral 20 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid20(&mut self) -> Pid20W<PmcSlpwkEr0Spec> {
        Pid20W::new(self, 20)
    }
    #[doc = "Bit 21 - Peripheral 21 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid21(&mut self) -> Pid21W<PmcSlpwkEr0Spec> {
        Pid21W::new(self, 21)
    }
    #[doc = "Bit 22 - Peripheral 22 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid22(&mut self) -> Pid22W<PmcSlpwkEr0Spec> {
        Pid22W::new(self, 22)
    }
    #[doc = "Bit 23 - Peripheral 23 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid23(&mut self) -> Pid23W<PmcSlpwkEr0Spec> {
        Pid23W::new(self, 23)
    }
    #[doc = "Bit 24 - Peripheral 24 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid24(&mut self) -> Pid24W<PmcSlpwkEr0Spec> {
        Pid24W::new(self, 24)
    }
    #[doc = "Bit 25 - Peripheral 25 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid25(&mut self) -> Pid25W<PmcSlpwkEr0Spec> {
        Pid25W::new(self, 25)
    }
    #[doc = "Bit 26 - Peripheral 26 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid26(&mut self) -> Pid26W<PmcSlpwkEr0Spec> {
        Pid26W::new(self, 26)
    }
    #[doc = "Bit 27 - Peripheral 27 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid27(&mut self) -> Pid27W<PmcSlpwkEr0Spec> {
        Pid27W::new(self, 27)
    }
    #[doc = "Bit 28 - Peripheral 28 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid28(&mut self) -> Pid28W<PmcSlpwkEr0Spec> {
        Pid28W::new(self, 28)
    }
    #[doc = "Bit 29 - Peripheral 29 SleepWalking Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid29(&mut self) -> Pid29W<PmcSlpwkEr0Spec> {
        Pid29W::new(self, 29)
    }
}
#[doc = "SleepWalking Enable Register 0\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_slpwk_er0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmcSlpwkEr0Spec;
impl crate::RegisterSpec for PmcSlpwkEr0Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`pmc_slpwk_er0::W`](W) writer structure"]
impl crate::Writable for PmcSlpwkEr0Spec {
