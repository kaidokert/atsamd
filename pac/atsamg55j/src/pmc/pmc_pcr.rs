...
impl DivR {
    ...
    pub fn is_periph_div8_mck(&self) -> bool {
        *self == Div::PeriphDiv8Mck
    }
}
#[doc = "Field `DIV` writer - Divisor Value"]
pub type DivW<'a, REG> = crate::FieldWriter<'a, REG, 2, Div, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Peripheral clock is MCK/8"]
    #[inline(always)]
    pub fn periph_div8_mck(self) -> &'a mut crate::W<REG> {
        self.variant(Div::PeriphDiv8Mck)
    }
}
