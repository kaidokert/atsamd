...
pub type R = crate::R<PmcSlpwkSr0Spec>;
...
#[doc = "SleepWalking Status Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pmc_slpwk_sr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmcSlpwkSr0Spec;
impl crate::RegisterSpec for PmcSlpwkSr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmc_slpwk_sr0::R`](R) reader structure"]
impl crate::Readable for PmcSlpwkSr0Spec {}
#[doc = "`reset()` method sets PMC_SLPWK_SR0 to value 0"]
impl crate::Resettable for PmcSlpwkSr0Spec {
